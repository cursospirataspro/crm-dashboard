...
require_once __DIR__ . '/includes/email-automations.php';

register_activation_hook( __FILE__, 'cpp_email_automations_activate' );
register_deactivation_hook( __FILE__, 'cpp_email_automations_deactivate' );
